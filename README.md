...
- A multisig authority is now known to work, but none exists. The three members
  ...
  the governance.
- No release has ever executed on a public cluster and none can before 2028.
  The 730-day cliff, the 30-day notice, the 90-day rotation notice and the
  silence grace all need time control a public cluster does not have, so what
  they produce on devnet are refusals. The aggregate market-capacity rule binds
  at release time and was therefore not exercised there either.
