...
import { boundLaunchIdentity, encodeConfig } from './launch_v6_identity.mjs';

const v = JSON.parse(readFileSync(new URL('../spec/LAUNCH_V6_IDENTITY_VECTOR_v1.json', import.meta.url)));
