...
import { boundLaunchIdentity, encodeConfig } from './launch_v5_identity.mjs';

const v = JSON.parse(readFileSync(new URL('../spec/LAUNCH_V5_IDENTITY_VECTOR_v1.json', import.meta.url)));
