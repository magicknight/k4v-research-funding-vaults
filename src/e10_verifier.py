"""E-10 raw-account, pinned immutable local loader and continuity verification.
...
from launch_v6_verifier import PROGRAM, verify, read_policy, require
...
CODE_BYTES = 529584
CODE_SHA256 = '36e5b4f8916d7c4844e625f8665dd91b8057c43e88699168d0cb2936cd02c171'
...
def expand_bundle(bundle):
    require(bundle['schema'] == 'K4V-E10-REHEARSAL-BUNDLE-v1', 'BUNDLE_SCHEMA')
