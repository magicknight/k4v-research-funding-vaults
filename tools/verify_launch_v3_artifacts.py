#!/usr/bin/env python3
"""Read-only exact binding gate for both TEST_ONLY v3 build profiles and IDL."""
import hashlib
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
candidate = json.loads((ROOT / "spec/LAUNCH_V3_TEST_ONLY_CANDIDATE_v1.json").read_text())
