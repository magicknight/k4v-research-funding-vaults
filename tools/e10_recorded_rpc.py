#!/usr/bin/env python3
"""Serve E-10 signed local-runtime bytes over loopback HTTP, never a live chain."""
import argparse
import base64
...
from e10_verifier import expand_bundle  # noqa: E402
from launch_v6_verifier import read_policy  # noqa: E402
from launch_v6_rpc_exporter import Client, MANIFEST_SCHEMA, export  # noqa: E402
...
def reproduce(bundle_path):
    ...
    return {"schema": "K4V-E10-LOOPBACK-REPLAY-v1", "valid": True,
            "scope": "LOCAL_HTTP_REPLAY_OF_SIGNED_E10_FIXTURES", "checkpoints": len(results),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--bundle", type=Path, default=ROOT / "examples/e10_rehearsal_bundle.json")
    parser.add_argument("--output", type=Path, required=True)
    args = parser.parse_args()
    result = reproduce(args.bundle)
    args.output.write_text(json.dumps(result, indent=2) + "\n")
    print(f"E-10 loopback HTTP: {result['checkpoints']} checkpoints, {result['rpc_requests']} read-only requests; zero public RPC")
