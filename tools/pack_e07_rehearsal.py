#!/usr/bin/env python3
"""Lossless E-07 packaging using the existing content-addressed blob format."""
import argparse
import json
...
def pack(raw):
    if raw['schema'] != 'K4V-E07-LOCAL-REHEARSAL-v1':
    ...
    result['schema'] = 'K4V-E07-REHEARSAL-BUNDLE-v1'
    return result
...
if __name__ == '__main__':
    ...
    print(f"Packed {len(result['checkpoints'])} E-07 checkpoints / {len(result['blobs'])} raw blobs")
