...
def read(name):
    ...
    assert data['schema'] == 'K4V-E11B-V7-SUBMISSION-PROBE-v1' and data['probe'] == name
    assert data['scope'] == 'SIGNED_LOCAL_LITESVM_ON_V7_TEST_SBF' and data['program_id'] == PROGRAM
...
print('E-11B signed probes: 142 target transactions; 44 accepted / 98 expected refusals; PASS')
