"""Adversarial edits to signed-runtime E-07 raw bytes, with no IDL decoder."""
import base64
import copy
import hashlib
import json
...
from e07_verifier import expand_bundle, verify_bundle, verify_graph, CODE_BYTES
...
class V5VerifierTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.bundle = json.loads((ROOT/'examples/e07_rehearsal_bundle.json').read_text())
    ...
    def test_proposal_role_predecessor_successor_epoch_and_notice_are_reconstructed(self):
        for offset, value, kind in [(40, 1, 'B'), (41, 2, 'Q'), (49, 1, 'Q'),
                                    ...
                                    (121, 2, 'B'), (130, 1, 'q'), (138, 1, 'q'), (146, 7, 'B')]:
