...
#[account]
#[derive(InitSpace)]
pub struct WithdrawalProposalV5 {
    pub policy: Pubkey,
    pub role: u8,
    pub nonce: u64,
    pub epoch: u64,
...
pub enum LaunchError {
    ...
    IneligibleSuccessor,
    #[msg("Signed proposal clock must equal the executing TEST_ONLY bank clock")]
    ProposalClock,
...
pub fn identity(
    ...
    solana_sha256_hasher::hashv(&[
        b"k4v-launch-policy-v5-test-profile-1",
        crate::ID.as_ref(),
        creator.as_ref(),
        mint.as_ref(),
        founder.as_ref(),
