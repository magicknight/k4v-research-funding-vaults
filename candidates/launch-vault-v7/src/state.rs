...
/// Immutable content-addressed intent. No update or close instruction exists.
...
#[account]
#[derive(InitSpace)]
pub struct WithdrawalProposalV7 {
    pub policy: Pubkey,
    pub role: u8,
    pub nonce: u64,
    pub epoch: u64,
...
pub fn identity(
    ...
    solana_sha256_hasher::hashv(&[
        b"k4v-launch-policy-v7-test-profile-1",
        crate::ID.as_ref(),
        creator.as_ref(),
        mint.as_ref(),
        founder.as_ref(),
